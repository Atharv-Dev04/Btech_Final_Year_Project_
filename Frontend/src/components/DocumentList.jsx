    ...
    const fetchDocuments = async () => {
        ...
        try {
            ...
            if (response.status === 'success' && response.data.documents?.length > 0) {
                ...
                // Use demo data if backend is empty or doesn't support the call yet
        ...
        <div className="space-y-8 animate-fade-in relative">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-400">Manage and browse your uploaded news articles and reports. {documents === DEMO_DOCUMENTS && <span className="text-indigo-400 text-xs font-black uppercase ml-2 tracking-tighter bg-indigo-500/10 px-2 py-0.5 rounded-md border border-indigo-500/20">Demo Data</span>}</p>
                </div>
