...
import { DEMO_DOCUMENTS, DEMO_SUMMARY } from '../services/demoData';
    ...
    const fetchDocuments = async () => {
        try {
            ...
            if (response.status === 'success' && response.data.documents?.length > 0) {
                ...
                setSelectedDocId(DEMO_DOCUMENTS[0].document_id);
            }
        } catch (err) {
                    ...
                    <div className="animate-fade-in space-y-8 p-10">
                        <div className="space-y-6">
                            <div className="flex items-center gap-3">
                                ...
                                {summaryData === DEMO_SUMMARY && <span className="text-indigo-400 text-[10px] font-black uppercase ml-2 tracking-tighter bg-indigo-500/10 px-2 py-0.5 rounded-md border border-indigo-500/20">Demo</span>}
                            </div>

                            {/* English Summary */}
                            <div className="space-y-3">
                                <div className="flex items-center gap-2">
                                    <span className="text-xs font-black text-gray-500 uppercase tracking-widest">English Summary</span>
                                </div>
                            ...
                            {Object.keys(summaryData.summary).length > 1 && (
                                <div className="space-y-3">
                                    ...
                                    <div className="p-12 bg-indigo-500/5 border border-indigo-500/10 rounded-[32px] text-indigo-100 leading-loose font-medium text-lg shadow-inner">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="p-6 rounded-[24px] bg-indigo-500/10 border border-indigo-500/20 shadow-sm relative overflow-hidden group">
                                ...
                                <p className="text-4xl font-black text-indigo-400 tracking-tight">{summaryData.stats.reduction_percentage}%</p>
                            ...
                            <div className="p-6 rounded-[24px] bg-blue-500/10 border border-blue-500/20 shadow-sm relative overflow-hidden group">
                                ...
                                <p className="text-4xl font-black text-blue-400 tracking-tight">{summaryData.stats.time_taken}s</p>
