...
import { DEMO_ENGAGEMENT } from '../services/demoData';
    ...
    return (
        <div className="space-y-10 animate-fade-in max-w-6xl mx-auto">
            <div>
                ...
                <p className="text-gray-400 text-lg font-medium">Detailed audit of AI function utilization and system throughput. {usageData === DEMO_ENGAGEMENT && <span className="text-indigo-400 text-xs font-black uppercase ml-2 tracking-tighter bg-indigo-500/10 px-2 py-0.5 rounded-md border border-indigo-500/20">Demo</span>}</p>
            </div>
