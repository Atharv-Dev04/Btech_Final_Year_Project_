...
const DEMO_NEWS = [
    {
        _id: 'demo-1',
        title: 'Quantum Leap: New Processor Breaks 1000-Qubit Barrier',
        summary: 'A breakthrough in quantum computing as researchers successfully operate a stable 1121-qubit processor, promising exponential speedups for complex simulations.',
        source: 'Tech Daily',
        category: 'technology',
    ...
    },
    {
        ...
        summary: 'Major indices hit record highs as latest economic data sugiere a soft landing is more likely than previously anticipated by experts.',
        source: 'Finance Times',
        category: 'world',
        published_date: new Date(Date.now() - 3600000).toISOString(),
        image_url: 'https://images.unsplash.com/photo-1611974714024-4607a5a48191?auto=format&fit=crop&q=80&w=800'
    },
    {
        _id: 'demo-3',
        title: 'Sustainable Cities: The Urban Forestry Revolution',
        summary: 'Metropolises around the world are adopting "vertical forests" and massive urban rewilding projects to combat heat islands and improve air quality.',
        source: 'Earth Watch',
        category: 'world',
        published_date: new Date(Date.now() - 7200000).toISOString(),
        image_url: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?auto=format&fit=crop&q=80&w=800'
    },
    {
        _id: 'demo-4',
        title: 'AI in Medicine: Diagnosis Speed Increases Tenfold',
        summary: 'A new neural network model trained on millions of scans can identify early-stage anomalies with higher precision than human specialists.',
        source: 'Medical News',
        category: 'technology',
        published_date: new Date(Date.now() - 10800000).toISOString(),
        image_url: 'https://images.unsplash.com/photo-1576091160550-217359f4ecf8?auto=format&fit=crop&q=80&w=800'
    }
];
    ...
    const fetchNews = async (cursor = null, isNext = true, overrideLimit = null) => {
        ...
        try {
            ...
            if (response.status === 'success') {
                ...
                // Blend demo news if it's the first page and filters are default
                const blendedItems = (cursor === null && filters.continent === 'all' && filters.country === 'all' && filters.language === 'all' && filters.source === 'all')
                    ? [...DEMO_NEWS, ...fetchedNews]
                    : fetchedNews;
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        title="Refresh news"
                    >
                        <RefreshCw size={20} className={`text-indigo-400 ${loading ? 'animate-spin' : ''}`} />
                    </button>
                </div>
            </div>
                                ...
                                >
                                    ...
                                    <div className="p-8 flex-1 flex flex-col">
                                        <div className="flex items-center gap-3 text-gray-400 text-xs font-bold mb-4">
                                            <span className="hover:text-indigo-400 transition-colors cursor-pointer">{article.source || 'Unknown Source'}</span>
