...
import { DEMO_DOCUMENTS, DEMO_KEYWORDS } from '../services/demoData';
                    ...
                    <div className="space-y-12 animate-fade-in">
                                ...
                                <div className="flex gap-2">
                                    {availableLanguages.map(lang => (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-xl font-bold text-sm transition-all ${selectedLanguage === lang
                        ...
                        <div className="p-10 bg-white/5 border border-white/10 rounded-3xl">
                            <div className="flex items-center gap-3 mb-10">
                                ...
                                {keywordData === DEMO_KEYWORDS && <span className="text-indigo-400 text-[10px] font-black uppercase ml-2 tracking-tighter bg-indigo-500/10 px-2 py-0.5 rounded-md border border-indigo-500/20">Demo</span>}
