    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
                ...
                <p className="text-gray-500 font-bold">Auditing system throughput...</p>
            </div>
        );
    }
                            ...
                            <div className="flex items-center justify-between mb-6">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">{item.active_module}</p>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <p className="text-2xl font-black text-gray-900 leading-none mb-1">{item.invocations.toLocaleString()}</p>
